...
def main():
    ...
    class User(Base):
        __tablename__ = 'new_bike_stations_real_time'
    ...
    #engine = create_engine('mysql+pymysql://projectdbDB:projectdbDB@projectdbdb.cwbskmf7sh3r.us-west-2.rds.amazonaws.com/projectdbDB')
        ...
        try:
            ...
            for i in results:
                ...
                ed_user = User(number=i['number'], contract_name=i['contract_name'], name=i['name']
                               , address=i['address'], position_lat=i['position']['lat'], position_lng=i['position']['lat'],
                               banking=i['banking'], bonus=i['bonus'], status=i['status'], bike_stands=i['bike_stands']
                               , available_bike_stands=i['available_bike_stands'], available_bikes=i['available_bikes'], last_update=time_date)
